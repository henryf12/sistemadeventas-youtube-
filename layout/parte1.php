...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <a href="#" class="nav-link">Sistema de Informacion</a>
      </li>
    </ul>
    <!-- Right navbar links -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>" class="brand-link">
      <img src="<?php echo $URL;?>/public/images/reparar.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SIS INFORMACION</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
